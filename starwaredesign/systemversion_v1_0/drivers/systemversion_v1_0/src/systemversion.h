...
#define SYSTEMVERSION_FPGA_BUILD_VERSION_OFFSET  4
#define SYSTEMVERSION_BOARD_VERSION_OFFSET 8
...
#define SYSTEMVERSION_FPGA_VERSION_MAJ_OFFSET    8
#define SYSTEMVERSION_FPGA_VERSION_MAJ_MASK      0x0000FF00U 	
#define SYSTEMVERSION_FPGA_VERSION_MIN_OFFSET    0
#define SYSTEMVERSION_FPGA_VERSION_MIN_MASK      0x000000FFU 	
